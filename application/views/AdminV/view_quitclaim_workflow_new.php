                          ...
                          <tbody>
                            <?php
                              foreach($users as $u)
                              {
                                ...
                                {
                                  if($u->quitclaim_approvers_eid == $un->user_employeeID)
                                  {
                                    $name = $un->user_firstname.' '.$un->user_lastname;
                                  }
                                }
                            ?>
                            <tr class="even pointer">
                              <td class=" "><?php echo $name; ?></td>
                              <td class=" "><a href="<?php echo base_url();?>admin/edit_quitclaim_workflow/<?php echo $u->quitclaim_approvers_eid?>">Edit</a></td>
                            </tr>
                            <?php
                            }
                          }
