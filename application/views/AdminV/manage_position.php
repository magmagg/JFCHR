                         ...
                         <?php
                                    if(!empty($position))
                                    {
                                        ...
                                        foreach($position as $p)
                                        {
                                            ...
                                            echo '<td>'.$p->position.'</td>';
                                            echo '<td style="text-align: center;">';?> <a href="#myModal" data-toggle="modal" data-updatingid="<?php echo $p->position_id ?>" data-updatingname="<?php echo $p->position?>">Update</a><?php echo '</td>';
                                            echo '<td style="text-align: center;">';
                                            ?><a href="#" data-href="<?php echo base_url();?>Admin/delete_position/<?php echo $p->position_id?>" data-toggle="modal" data-target="#confirm-deactivate">Delete</a><?php echo '</td>';
                                            echo '</td>';
                                            echo '</tr>';
                                            $count +=1;
                                        }
...
<?php
                                    ...
                                    {
                                        echo '<div class="alert alert-danger text-center">No Positions available.</div>';
                                    }
                                    ?>
                          </div>
                        <!-- .panel-body -->
