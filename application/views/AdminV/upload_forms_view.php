              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" style="min-height:600px;">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data" method="POST" action="<?php echo base_url(); ?>Admin/do_upload">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Document Name <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" name="docuname" placeholder="Document name" required>
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="col-md-3 col-sm-3 col-xs-12 control-label"> Document Category
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <div class="radio">
                            <label>
                              <input type="radio" class="flat" checked name="docucateg" id="inlineRadio1" value="Forms"> Forms
                            </label>
                            <label>
                              <input type="radio" class="flat" name="docucateg" id="inlineRadio2" value="Templates"> Templates
                            </label>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12"> Companies
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <?php
                          ...
                          <div class="checkbox">
                            <label>
                              <?php
                                    ...
                                    echo '<input type="checkbox" class="flat" name="company[]" value='.'" '.$c.'"> '.$c;
                              ?>
                            </label>
                          </div>
                          <?php
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name"> File input <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
